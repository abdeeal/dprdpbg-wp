<?php
/**
 * The template for displaying Tokoh Sejarah archive page
 *
...
<main id="primary" class="w-full bg-main min-h-screen pt-10 pb-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <header class="mb-12 mt-6">
            <h1 class="font-display text-4xl text-primary font-bold mb-4">Tokoh Sejarah Purbalingga</h1>
            <p class="font-sans text-body-secondary text-[15px] max-w-2xl">
                Mengenal tokoh-tokoh penting dan pemimpin yang berjasa dalam sejarah perkembangan Kabupaten Purbalingga.
            </p>
        </header>
