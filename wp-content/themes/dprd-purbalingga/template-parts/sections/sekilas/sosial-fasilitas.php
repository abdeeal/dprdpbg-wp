...
?>
<section data-fade id="sosial-fasilitas" class="mb-16 scroll-mt-24">
        ...
        <tbody>
          <?php foreach ($data['pendidikan'] as $item) : ?>
            <tr class="border-b border-line last:border-b">
              ...
              <td class="py-4 px-4 font-mono text-body text-[14px] text-right" data-counter><?php echo esc_html($item['jumlahSekolah']); ?></td>
              <td class="py-4 px-4 font-mono text-body text-[14px] text-right" data-counter><?php echo esc_html($item['totalGuru']); ?></td>
              <td class="py-4 px-4 font-mono font-bold text-primary text-[14px] text-right" data-counter><?php echo esc_html($item['totalSiswa']); ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
      <?php foreach ($data['kesehatan']['fasilitas'] as $fasilitas) : ?>
        <div class="bg-[#F0EEE7] rounded-card p-5 flex flex-col justify-between h-full">
          ...
          <div class="font-mono text-[24px] md:text-[28px] font-bold text-primary tracking-tight leading-none mt-auto" data-counter>
